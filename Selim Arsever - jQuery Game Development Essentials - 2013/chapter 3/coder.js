$(function() {
    // добовляем спрайты в объект анимация
...
// инилизация начальных объектов
    var initialize = function() {
        ...
        //привязываем анимацию к созданным спрайтам 
...
//проверка на столкновение
 ...
 // начальная застака (при клике инициализирует все объекты и аппендит их в дом)   
